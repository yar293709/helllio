...
const execShellCommand = (cmd, needOutput = true, detached = false, pidfile = null) => {
  ...
  return spawn_wrap((0,external_child_process_namespaceObject.spawn)(cmd, [], { shell: true, detached: detached }), needOutput, pidfile)
}


const execCommand = (cmd, arg, needOutput = true, detached = false, pidfile = null) => {
    core.debug(`Executing shell command: [${cmd}]`)
    return spawn_wrap((0,external_child_process_namespaceObject.spawn)(cmd, arg, { detached: detached }), needOutput, pidfile)
  }
...
;// CONCATENATED MODULE: ./src/start_rdp.js
